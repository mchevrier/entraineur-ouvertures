    ...
    dict(
        ...
        variations=[
            dict(at=3, name="Le dragon inversé (2...Cc6 et ...g6)", moves=[
                ...
                ("d6", None),
                ("Rb1", "La clé de cette structure : tu prépares b4-b5 pour bousculer son cavalier c6 et ouvrir l'aile dame, là où tu es le plus fort. Ce n'est pas un coup machinal — c'est un PLAN."),
            ...
            dict(at=5, name="Le clouage 3...Fb4", moves=[
                ...
                ("O-O", None),
                ("e4", "Le coup malin ! Tu prends un grand centre. S'il échange en c3, tu obtiens un atout durable : la paire de fous."),
                ("Bxc3", None),

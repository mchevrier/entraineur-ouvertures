...
LINES = [
    ...
    dict(
        ...
        variations=[
            ...
            dict(at=3, name="L'attaque ...f5 (le Grand Prix inversé)", moves=[
                ("Nc6", None),
                ("g3", "Ton fianchetto habituel."),
                ("f5", "⚠️ Coup à repérer ! Il pousse ...f5 pour t'attaquer à l'aile roi (le « Grand Prix à l'envers »). Ça paraît menaçant... mais en réalité il affaiblit ses PROPRES cases, surtout e6 et la case d5. Pas de panique : tu ne réagis pas à la peur, tu réagis au jeu réel."),
                ("Bg2", "Tu finis ton fianchetto : ton fou g2 tape pile sur les cases qu'il vient d'affaiblir (b7, et bientôt d5)."),
                ("Nf6", None),
                ("d3", "Le bon réflexe : tu BLINDES ton centre au lieu de te jeter en avant. Plus la partie avance, plus son pion f5 deviendra une faiblesse."),
                ("g6", None),
                ("Nf3", "Développe en surveillant e5."),
                ("Bg7", None),
                ("O-O", "Roi à l'abri. Vois la différence : LUI a poussé les pions devant son roi (e5-f5, des trous derrière), TOI tu gardes un abri solide. C'est ça, ton avantage caché."),
                ("O-O", None),
                ("Rb1", "Et toujours le même plan : b4-b5 à l'aile dame. Pendant que son attaque ...f5 tourne à vide, toi tu joues là où tu es fort. Il s'est affaibli pour rien. 🛡️"),
            ]),
